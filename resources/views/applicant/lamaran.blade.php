...
@section('content')
    <div class="container" style="min-height:100vh; margin-top: 8rem;">
        <div class="row g-3">
            <div class="col-12">
                <form class="row g-3" action="{{ route('applicant.store.lamaran.process') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptionsDomisili"
                                                id="inlineRadio1" value="samektp" checked>
                                            <label class="form-check-label" for="inlineRadio1">Sesuai dengan
                                                KTP</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptionsDomisili"
                                                id="inlineRadio2" value="others">
                    ...
                    <div class="col-12 my-4">
                        <div class="card shadow rounded-4">
                            <div class="card-body">
                                ...
                                <hr>
                                <select class="form-select" aria-label="Pilih posisi yang dilamar" name="position_id">
                                    ...
                                    <div class="row education-item">
                                        <div class="col-12">
                                            <div class="float-end mt-3">
                                                <button class="btn btn-danger btn-remove-pendidikan" type="button">Hapus
                                                    riwayat</button>
                                            </div>
                                        </div>
                                        <div class="col-12">
